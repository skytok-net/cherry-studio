...
import type { ExecutionMode, TranspilationRequest } from './ITranspilationService';
import type { ITranspilationProvider, ProviderError, ProviderInfo } from '../providers/ITranspilationProvider';
